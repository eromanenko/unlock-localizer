...
const SKIP_BOXES = ['Demos', 'Fantastic'];

const svgChevron = `<svg class="box-banner-chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>`;
...
export function renderCatalog(boxes, descriptions, lang, uiStrings, onSelect) {
  ...
  for (const box of boxes) {
    ...
    // Chevron: append via insertAdjacentHTML to avoid innerHTML reset
    banner.insertAdjacentHTML('beforeend', svgChevron);
